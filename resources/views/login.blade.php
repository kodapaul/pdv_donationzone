                ...
                <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
                    <div class="space-y-2">
                        ...
                        <p class="text-sm font-light text-gray-500 dark:text-gray-400">
                            Don’t have an account yet? <a href="{{ route('registration_page') }}"
                                class="font-medium text-primary-blue-light hover:underline dark:text-primary-blue-light">Sign
                                up</a>
                        </p>
                    </div>
                    <form class="space-y-4 md:space-y-6" id="login" action="{{ route('login') }}" method="POST">
                        @csrf
                        <div>
                            ...
                            @if (Session::has('login_error'))
                                <p class="text-sm font-light text-red-500 dark:text-red-500">
                                    Your password and email doesn't match</p>
                            @endif
